# import schwabdev #created by Tyler Bowers 2024

# client = schwabdev.Client(api_key, api_secret)
...
class Client:
    ...
    def __init__(self, app_key=api_key, app_secret=api_secret, callback_url="https://127.0.0.1", tokens_file="tokens.json", timeout=5, verbose=True, show_linked=True):
        """
...
new_client = Client(app_key=app_key, app_secret=app_secret)

with open('tokens.json', 'r') as token_file:
    token_data = json.load(token_file)

bearer = token_data['token_dictionary']['access_token']